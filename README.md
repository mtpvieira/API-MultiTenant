...
- Implementar a resolução de Tenants via URL.
- Explorar padrões de isolamento de dados.
- Configurar Migrations automáticas para diferentes contextos.
- Utilizar recursos do .NET 10 e C# 14.

## 🏗️ Estratégias de Arquitetura

O projeto aborda os dois principais modelos de isolamento:
...
2.  **Database per Tenant (Isolamento Físico):** Cada tenant possui sua própria string de conexão e banco de dados independente.
